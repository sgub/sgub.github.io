...
4. 带有静噪功能的接收机关闭静噪功能时，按照灵敏度定义测得的灵敏度

---

## LK0854
### “衰减”和“衰落”是无线电通信技术中常用的名词。它们的含义分别是指：
1. 衰减是指信号通过信道或电路后功率减少，衰落是指信号通过信道或电路后发生幅度随时间而起伏
2. 衰减是指信号通过信道或电路后发生幅度随时间而起伏，衰落是指信号通过信道或电路后功率减少
3. 衰减和衰落是一回事，指信号通过信道或电路后功率减少
4. 衰减和衰落是一回事，指信号通过信道或电路后发生幅度随时间而起伏
...
1. 特性阻抗和工作频率下单位长度的传输功率损耗
2. 铜或铝导线的截面积和常温下的最大额定电流
3. 导线绝缘层的耐压和最高额定环境温度
4. 长度为1/4波长、终端分别为开路和短路时的电压驻波比

---

## LK0918
### 通常把垂直偶极天线或者垂直接地天线称为“全向天线”，是因为：
1. 它们在水平方向没有指向性，但在立体空间有方向性
2. 它们在垂直方向没有指向性，但在立体空间有方向性
3. 它们在水平方向和垂直方向都有指向性
4. 它们在空间没有指向性，向各个方向均匀辐射

---

## LK0919
### 振子电气长度为1/4波长的垂直接地天线的最大辐射方向为：
1. 在水平方向没有指向性，在垂直方向指向水平面
2. 在空间没有指向性，向各个方向均匀辐射
3. 在垂直方向没有指向性，在水平方向指向前方
4. 在水平方向呈现8字形方向特性

---

## LK0925
### 垂直接地天线（GP）的构造为电气长度为1/4波长的垂直振子加一个“接地”反射体，因其简单而被大量应用于手持和车载业余电台，但这种天线的实际工作情况往往与理论值相差较大，尤其在频率较低的频段。最常见的原因和改善办法是：
1. 缺乏有效的接地反射体。GP天线必须有足够大的接地反射体来形成振子镜像，否则谐振频率和阻抗都将与理论值有显著偏差，应尽量用大面积金属体与天线的接地端直接连接
2. 1/4波长垂直振子太短。改成1/2波长即可解决问题
3. 1/4波长垂直振子太短。在振子中串联加感线圈即可解决问题
4. 一般天线与电缆直接相连，匹配不良。在天线和电联之间加接“巴伦”即可解决问题

---

## LK0926
### 天线增益是指：
1. 天线在最大辐射方向上的辐射功率密度与相同条件下基准天线的辐射功率密度之比
2. 天线在接收或发射信号时所具有的放大倍数
3. 天线辐射到空间的电磁波功率与输入到天线的总射频功率之比
4. 输入到天线的总射频功率与天线辐射到空间的电磁波功率之比

---

## LK0929
### 某商品天线说明书给出的增益指标以dBi为单位。其意义为：
1. “相对于无方向性点源天线的增益”，即最大辐射方向上的辐射功率密度与理想点源天线的辐射功率密度之比
2. “相对于半波长偶极子天线的增益”，即最大辐射方向上的辐射功率密度与半波长偶极振子的最大辐射功率密度之比
3. “相对于垂直短天线的增益”，即以高度远小于波长的短垂直天线作为基准作为比较基准得到的天线增益
4. “相对于1/4波长接地天线的增益”，即以1/4波长垂直接地天线作为比较基准得到的天线增益

---

## LK0930
### 某商品天线说明书给出的增益指标以dBd为单位。其意义为：
1. “相对于半波长偶极子天线的增益”，即最大辐射方向上的辐射功率密度与半波长偶极振子的最大辐射功率密度之比
2. “相对于无方向性点源天线的增益”，即最大辐射方向上的辐射功率密度与理想点源天线的辐射功率密度之比
3. “相对于1/4波长接地天线的增益”，即以1/4波长垂直接地天线作为比较基准得到的天线增益
4. 这种表达没有说清楚计算增益所采用的比较基准，缺乏实际意义

---

## LK0931
### 某商品天线说明书给出的增益指标以dB为单位。其意义为：
1. 这种表达没有说清楚计算增益所采用的比较基准，缺乏实际意义
2. “相对于半波长偶极子天线的增益”，即最大辐射方向上的辐射功率密度与半波长偶极振子的最大辐射功率密度之比
3. “相对于无方向性点源天线的增益”，即最大辐射方向上的辐射功率密度与理想点源天线的辐射功率密度之比
4. “相对于垂直短天线天线的增益”，即以高度远小于波长的短垂直天线作为基准作为比较基准得到的天线增益

---

## LK0932
### 两款VHF垂直全向天线，用作发射。甲天线增益4.5dBd，乙天线增益为5.85dBi。它们在远处某接收天线中形成的信号功率差为：
1. 甲信号比乙信号强0.8dB
2. 乙信号比甲信号强1.35dB
3. 甲信号比乙信号强1.35dB
4. 乙信号比甲信号强3.5dB
...
## LK0973
### 天线工程中计算振子长度时需要知道电波在天线中的传播速度。电波在天线导线中的传播速度大约是：
1. 真空波速的0.95倍
2. 真空波速的1.05倍
3. 与真空波速相同
4. 真空波速的1.41倍
...
## LK0974
### 天线工程中计算馈线长度时经常需要知道电波在馈线中的传播速度。常用业余频段的电波在同轴电缆中的传播速度大约是：
1. 真空波速的0.65倍
2. 真空波速的1.54倍
3. 真空波速的1.65倍
4. 与真空波速相同
...
1. 与距离的平方成正比，与频率的平方成正比
2. 与距离的平方成正比，与频率的平方成反比，
3. 与距离成正比，与频率的平方成正比
4. 与距离的平方成正比，与频率无关
...
## LK1062
### 以dBd为单位的天线增益则是指：
1. 最大辐射方向辐射功率密度与半波长振子最大辐射方向辐射功率密度之比的dB值
2. 最大辐射方向辐射功率密度与理想点源天线最大辐射方向辐射功率密度之比的dB值
3. 最大辐射方向辐射功率密度与1/4波长垂直接地天线水平方向辐射功率密度之比的dB值
4. 最大辐射方向辐射功率密度与最小辐射方向辐射功率密度之比的dB值

---

## LK1063
### 以dBi为单位的天线增益则是指：
1. 最大辐射方向辐射功率密度与理想点源天线最大辐射方向辐射功率密度之比的dB值
2. 最大辐射方向辐射功率密度与半波长振子最大辐射方向辐射功率密度之比的dB值
3. 最大辐射方向辐射功率密度与1/4波长垂直接地天线水平方向辐射功率密度之比的dB值
4. 最大辐射方向辐射功率密度与最小辐射方向辐射功率密度之比的dB值
...
## LK1067
### 地波是沿地面传播的无线电波，其衰减因子取决于：
1. 电波频率、地面导电率和传播距离
2. 电波频率、太阳活动情况和地磁活动情况
3. 电波频率、发射功率和天线增益
4. 天线高度、发射功率和调制方式
...
## LK1068
### 决定超短波视距传播距离极限的主要因素是：
1. 发射天线和接收天线离地面的相对高度值
2. 发射天线和接收天线离海平面的绝对高度值
3. 发射天线和接收天线离地面的相对于波长的高度系数，即离地高度除以波长
4. 发射天线和接收天线的增益
...
1. 可能使误码率增大
2. 随着传播路径的增加，接收到的数据速率会线性地减小
3. 如果使用FM方式调制的话，不会观察到任何反常现象
4. 随着传播路径的增加，数据通信速率会线性地增加

---

## LK1106
### 在一个周期内，电磁波走过一定的距离，这个距离叫做：
1. 波长
2. 波形
3. 波速
4. 波展
...
## LK1111
### 在已知电磁波频率的情况下，下面哪一种方法可以用来计算它的波长？
1. 使用300除以频率的兆赫数（MHz）可以得到以米为单位的波长
2. 将频率的赫兹数（Hz）除以300可以得到以米为单位的波长
3. 将频率的兆赫数（MHz）除以300可以得到以米为单位的波长
4. 使用频率的赫兹数（Hz）乘以300可以得到以米为单位的波长
...
## LK1116
### 如果你收到了一个从上千公里以外的距离传播过来的VHF信号，最可能的原因是：
1. 信号被突发E电离层反射过来
2. 信号经过了地下传输过来
3. 信号被附近的雷雨区反射过来
4. 信号经过了宇宙的反射
...
## LK1126
### 安装哪个部件可以减少在音频同轴电缆屏蔽层外皮中的感应射频电流？
1. 在电缆外面套铁氧体磁环
2. 在电缆芯线中串联低通滤波器
3. 在电缆前端前置放大器
4. 在电缆芯线中串联带通滤波器
...
## LK1143
### 下列哪一个缩写经常在无线电工程文章中用来代表各种类型的无线电波？
1. RF
2. HF
3. AF
4. VHF
...
## LK1169
### 下列部件中经常被用来把220伏的市电转换成更低电压交流电的是：
1. 变压器
2. 可变电容器
3. 晶体管
4. 二极管
...
### 射频同轴电缆在业余电台中的主要用处是？
1. 将无线电信号从发射机传送到天线
2. 将电能从汽车的电池输送到移动车载电台
3. 用来遮蔽天线塔上的支杆，管子等柱状物体
4. 将信号从TNC传送到电脑
...
## LK1180
### 接收机“过载”通常是指：
1. 输入信号过于强大，以致导致机内产生附加干扰
2. 接收机消耗的电流太大了
3. 接收机电源的电压太高了
4. 由于接收机的音量调节得过大而导致的附加干扰
...
1. 紫外线能破坏电缆的外皮，使水分渗入
2. 紫外线会使电缆外皮中的功率损耗加大
3. 紫外线和射频信号会混合在一起导致干扰
4. 这样就可以减少谐波

---

## LK1191
### 和固体电介质同轴电缆相比，空气电介质同轴电缆的劣势是什么？
1. 空气电介质电缆要采取特别的手段来防止水分进入电缆
2. 空气电介质电缆不能用于VHF或UHF段
3. 空气电介质电缆的每米损耗更大
4. 空气电介质电缆不能在冰点以下使用
...
## LK1213
### 就大多数手持电台随机附送的“橡皮天线”来说，它的劣势是什么？
1. 相对于全尺寸天线，它的发射和接收效率较低
2. 它发射的是圆极化的信号
3. 如果橡胶的一头损坏了，那么它很快就会解体
4. 以上三项全部正确
...
## LK1216
### 天线的增益是什么意思？
1. 相对于参考天线，在某一方向上信号强度的增加
2. 当发射机在更高的频率发射时，天线会额外地减少一部分功率
3. 对于发射机的功率输入，天线附加的一部分额外功率
4. 相对于参考天线，发射或接收时的阻抗增加

---

## LK1217
### 为什么在使用同轴电缆连接天线时，最好有一个较低的驻波比？
1. 使能量更有效率地传送，减少损耗
2. 减少对电视的干扰
3. 能延长天线的使用寿命
4. 能延长发信机的使用寿命
...
1. 因为它使用方便，与周围环境之间的相互影响小
2. 因为它比其它任何一种馈线的损耗都低
3. 因为它可以相对其它馈线传送更大的功率
4. 因为它比其它任何一种馈线都便宜

---

## LK1221
### 通过同轴电缆的信号频率越高，通常产生什么影响？
1. 损耗越高
2. 反射功率越高
3. 特性阻抗越高
4. 驻波比越高
...
## LK1229
### 如何在电网停电的状况下给一个12伏的铅酸蓄电池充电？
1. 将蓄电池连接与汽车的蓄电池并联，并且发动汽车
2. 给蓄电池中加一些酸
3. 将蓄电池放在冰里冷却一会儿
4. 将蓄电池串联一个电灯泡作为限流装置，然后连接到220伏市电上
...
## LK1231
### 如果铅酸蓄电池的充电和放电进行得过快会怎样？
1. 电池可能会过热，甚至释放出可燃气体，甚至可能爆炸
2. 电压会将为负值
3. “记忆效应”将使电池的可用容量减小
4. 可能会产生过高的充电电压，引起触电的危险
